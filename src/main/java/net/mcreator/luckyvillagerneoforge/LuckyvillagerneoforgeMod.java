package net.mcreator.luckyvillagerneoforge;
...
@Mod("luckyvillagerneoforge")
public class LuckyvillagerneoforgeMod {
	public static final Logger LOGGER = LogManager.getLogger(LuckyvillagerneoforgeMod.class);
	public static final String MODID = "luckyvillagerneoforge";

	public LuckyvillagerneoforgeMod(IEventBus modEventBus) {
